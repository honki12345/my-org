...
- ~@version text~
**** Code Snippets
This feature allows you to import code from external files
***** import an entire file
#+begin_src java
  {@snippet file=EmployeeTest.java}
  {@snippet class=com.horstmann.corejava.EmployeeTest.java}
#+end_src
Files should be placed in the ~snippet-files~ subdirectory of the current package
***** copy a region from a file
**** Comment Extraction
*** Class Design Hints
